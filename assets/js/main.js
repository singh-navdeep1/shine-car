  ...
  e(window).on("scroll", function () {
    ...
    (s = e(".sticky-active")),
      ...
      e(window).scrollTop() > 800
        ? (s.parent().addClass(n), o > t ? s.removeClass(a) : s.addClass(a))
    ...
    (e.fn.sectionSpace = function (t, s) {
      e(this).each(function () {
        ...
        (a = d.attr(t)),
          (n = d.attr(s)),
          (o = d.data("margin-top")),
          (i = d.data("margin-bottom")),
          (r = c(e(n).css("padding-top"))),
          (l = c(e(n).css("padding-bottom"))),
          "margin-top" === a
            ? (e(n).css("padding-bottom", l + c(o) + "px"),
              d
                .css("margin-top", "-" + c(o) + "px")
                .css({ position: "relative", "z-index": "3" }))
            : "margin-bottom" === a &&
              (e(n).css("padding-top", r + c(i) + "px"),
              d
                .css("margin-bottom", "-" + c(i) + "px")
                .css({ position: "relative", "z-index": "3" }));
      });
    });
  function d() {
  ...
  e("[data-sec-space]").length &&
    ...
    (e.fn.indicator = function () {
      ...
      function i() {
        ...
        n.css({ top: o, left: i, width: a, height: s });
      }
